    ...
    {if $history_order_changes_status}
        ...
        <div class="table-responsive-wrapper">
            ...
            <tr class="cm-row-status-{$request.order_id|lower}">
                <td data-th="{__("id")}">
                    <a href="{fn_url("orders.details?order_id={$request.order_id}")}">Заказ № {$request.order_id}
                </td>
...
{include file="common/mainbox.tpl" title=__("history_order_changes_status.name") content=$smarty.capture.mainbox sidebar=$smarty.capture.sidebar content_id="manage_history_order_changes_status"}
